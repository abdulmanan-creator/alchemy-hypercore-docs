...
> **Draft API contract**
> Return perpetual-account state for multiple users. This is a proposed named-parameter JSON-RPC 2.0 contract for backfill and reconciliation.

# hl_batchClearinghouseStates
...
```json
{
  "jsonrpc":"2.0",
  "id":1,
  "result":{ "states":[{"user":"0x1111111111111111111111111111111111111111","state":{"marginSummary":{},"assetPositions":[]}}],"missingUsers":[] }
}
```
