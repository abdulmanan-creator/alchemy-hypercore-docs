...
> P1 scope. Live market context including mark, oracle, funding, and open-interest values. The stream name, filter keys, data fields, and operational guarantees are proposed contracts for engineering review.
...
```json
{
  "jsonrpc": "2.0",
  "id": 1,
  "result": { "subscriptionId": "sub_01", "stream": "activeAssetCtx" }
}
```
