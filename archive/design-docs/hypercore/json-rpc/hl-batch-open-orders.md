...
> **Draft API contract**
> Return open orders for multiple users. This is a proposed named-parameter JSON-RPC 2.0 contract for backfill and reconciliation.
...
```json
{
  "jsonrpc":"2.0",
  "id":1,
  "result":{ "ordersByUser":[{"user":"0x1111111111111111111111111111111111111111","orders":[]}],"missingUsers":[] }
}
```
