...
> Return validator delegations for a user. The route choice, fields, pagination, and retention semantics are draft contracts unless supplied by a native-compatible implementation.
...
curl --request POST '<HYPERCORE_HTTP_URL>/info' \
  ...
  --data '{"type":"delegations","user":"0x1111111111111111111111111111111111111111"}'
```


## Proposed response
```json
{ "delegations": [{"validator":"0x3333333333333333333333333333333333333333","amount":"10.0","lockedUntilTimestamp":1780086400000}] }
```
