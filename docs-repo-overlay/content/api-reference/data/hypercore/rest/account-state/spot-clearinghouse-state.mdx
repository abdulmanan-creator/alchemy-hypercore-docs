...
| `balances[].coin`     | string  | Market identifier.                |
| `balances[].token`    | integer | Token index.                      |
| `balances[].hold`     | string  | Amount reserved by orders.        |
| `balances[].total`    | string  | Total amount.                     |
| `balances[].entryNtl` | string  | `entryNtl` value in the response. |
