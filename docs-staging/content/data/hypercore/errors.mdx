---
title: "Errors"
description: "This page defines a minimal proposed error model so clients can distinguish validation failures, authorization failures, misses, and replay gaps."
hidden: true
---
> **Draft API contract**
