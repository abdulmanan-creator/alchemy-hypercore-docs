...
description: "P1 scope. Executed fills attributed to builder-routed orders. The stream name, filter keys, data fields, and operational guarantees are proposed contracts "
hidden: true
---
