...
description: "P2 scope. OHLCV candle updates for selected markets and intervals. The stream name, filter keys, data fields, and operational guarantees are proposed contr"
hidden: true
---
