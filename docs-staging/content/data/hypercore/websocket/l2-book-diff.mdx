...
description: "P0 scope. Ordered L2 changes that apply to a previously received book state. The stream name, filter keys, data fields, and operational guarantees are prop"
hidden: true
---
