...
description: "P2 scope. Market-wide funding-rate updates. The stream name, filter keys, data fields, and operational guarantees are proposed contracts for engineering re"
hidden: true
---
