---
title: "bbo stream"
description: "P0 scope. Best bid and offer updates for a market. The stream name, filter keys, data fields, and operational guarantees are proposed contracts for enginee"
hidden: true
---
