...
description: "P2 scope. Non-funding ledger events scoped to users, such as transfers and deposits. The stream name, filter keys, data fields, and operational guarantees "
hidden: true
---
