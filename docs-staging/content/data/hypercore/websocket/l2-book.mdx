---
title: "l2Book stream"
description: "P0 scope. Aggregated L2 order-book snapshots for one market. The stream name, filter keys, data fields, and operational guarantees are proposed contracts f"
hidden: true
---
