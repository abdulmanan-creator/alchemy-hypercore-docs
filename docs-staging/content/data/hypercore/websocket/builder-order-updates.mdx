...
description: "P1 scope. Order lifecycle updates for orders attributed to builder codes. The stream name, filter keys, data fields, and operational guarantees are propose"
hidden: true
---
