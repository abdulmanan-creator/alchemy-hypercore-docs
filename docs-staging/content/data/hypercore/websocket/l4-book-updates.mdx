...
description: "P2 scope. Order-by-order book updates for markets selected by the consumer. The stream name, filter keys, data fields, and operational guarantees are propo"
hidden: true
---
