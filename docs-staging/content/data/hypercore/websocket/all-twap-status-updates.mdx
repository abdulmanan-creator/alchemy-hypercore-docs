...
description: "P2 scope. Market-wide TWAP status changes. The stream name, filter keys, data fields, and operational guarantees are proposed contracts for engineering rev"
hidden: true
---
