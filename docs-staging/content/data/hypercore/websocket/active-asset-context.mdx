...
description: "P1 scope. Live market context including mark, oracle, funding, and open-interest values. The stream name, filter keys, data fields, and operational guarant"
hidden: true
---
