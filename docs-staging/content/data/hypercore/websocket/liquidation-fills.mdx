...
description: "P1 scope. Executed fills explicitly identified as liquidation activity. The stream name, filter keys, data fields, and operational guarantees are proposed "
hidden: true
---
